...
function VideoMapping(params){
    ...
    var projectorResolution = {x:1920, y:1080}; //1400 1050
    ...
    this.preLoad = function(loader)
    {
        ...
        */
        imgSoft = loader.loadImage({ url: "sketches/common/3D/soft.png" });
        finalImg = loader.loadImage({ url: "sketches/3d/petite_salle_d1_50k_t1/petite_salle_d1_50k_t1_u1_v1.jpg" });
    ...
    this.setup = function()
    {
        ...
        //manage the debug mode given in the URL params
        var debugMode = this.getUrlParameter("debug_mode");
